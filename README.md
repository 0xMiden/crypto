...
- `SmtForest`: a collection of Sparse Merkle Trees with depth 64. Designed to efficiently store trees with common subtrees (smilar to `MerkleStore`) with a method to prune old unused trees.
