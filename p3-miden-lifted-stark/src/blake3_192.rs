...
//!
//! Use [`goldilocks`](`crate::blake3_192::goldilocks`) with [`crate::GenericStarkConfig`] the same
//! way as Poseidon2-based dev configs, but with byte LMCS (`LmcsConfig<F, u8, …>`).
