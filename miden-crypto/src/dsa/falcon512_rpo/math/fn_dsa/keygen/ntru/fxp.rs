...
impl FXR {
    ...
    pub(crate) fn set_abs(&mut self) {
        self.0 = self.0.wrapping_sub((self.0 << 1) & (((self.0 as i64) >> 63) as u64));
    }
...
// Note: Test module removed as we don't need sha2 imports (miden-crypto uses RPO)
