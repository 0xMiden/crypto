...
#[cfg(all(any(target_arch = "x86", target_arch = "x86_64"), not(target_feature = "lzcnt")))]
pub(crate) const fn bitlength(x: u32) -> u32 {
...
// Note: Test modules removed as we don't need sha2/num_bigint imports (miden-crypto uses RPO)
