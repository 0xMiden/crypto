...
mod neon {
    ...
    const ROT8_IDX: [u8; 16] = [1, 2, 3, 0, 5, 6, 7, 4, 9, 10, 11, 8, 13, 14, 15, 12];
    ...
    #[inline(always)]
    fn load_rot8_idx() -> uint8x16_t {
        unsafe { vld1q_u8(ROT8_IDX.as_ptr()) }
    }
    ...
    pub(super) fn compress_packed_4(cv: [[u32; 4]; 8], block: [[u32; 4]; 16]) -> [[u32; 4]; 8] {
        ...
        macro_rules! round {
            (
                ...
                v2 = add(add(v2, v6), m5);
                v3 = add(add(v3, v7), m7);
                v12 = rotr8_table(xor(v12, v0), rot8_idx);
                v13 = rotr8_table(xor(v13, v1), rot8_idx);
                v14 = rotr8_table(xor(v14, v2), rot8_idx);
                v15 = rotr8_table(xor(v15, v3), rot8_idx);
                v8 = add(v8, v12);
                v9 = add(v9, v13);
                v10 = add(v10, v14);
                v11 = add(v11, v15);
                ...
                v2 = add(add(v2, v7), m13);
                v3 = add(add(v3, v4), m15);
                v15 = rotr8_table(xor(v15, v0), rot8_idx);
                v12 = rotr8_table(xor(v12, v1), rot8_idx);
                v13 = rotr8_table(xor(v13, v2), rot8_idx);
                v14 = rotr8_table(xor(v14, v3), rot8_idx);
                v10 = add(v10, v15);
                v11 = add(v11, v12);
                v8 = add(v8, v13);
                v9 = add(v9, v14);
