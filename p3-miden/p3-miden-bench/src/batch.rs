...
pub(crate) fn run_batch_poseidon2(
    ...
    use p3_miden_lifted_stark::testing::configs::goldilocks_poseidon2 as gl;
...
pub(crate) fn run_batch_keccak(
    ...
    use p3_miden_lifted_stark::testing::configs::goldilocks_keccak as keccak;
...
pub(crate) fn run_batch_blake3(
    ...
    use p3_miden_lifted_stark::testing::configs::goldilocks_blake3 as blake3;
...
pub(crate) fn run_batch_blake3_192(
    ...
    use p3_miden_lifted_stark::testing::configs::goldilocks_blake3_192 as blake3_192;
    use p3_symmetric::{CompressionFunctionFromHasher, SerializingHasher};
